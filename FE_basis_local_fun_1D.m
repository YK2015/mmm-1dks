...
elseif basis_type == 103  % for cubic element(P3).
   ...
   elseif basis_type == 104  % for cubic element(P3).
    xb = 3/4*xl + 1/4*xr;  % cubic element need other two point.
    xc = 1/2*xr + 1/2*xl;  % xb for x_bottom(1/3 bottom), xt for x_top(2/3top).
    xt = 1/4*x1 + 3/4*xr; 
    switch basis_index
        case 1  % for xl
            switch basis_der
                case 0
                    result = (x-xc).*(x-xb).*(x-xt).*(x-xr)/(xl-xb)/(xl-xt)/(xl-xr)/(xl-xc);
                case 1
                    result = ((x-xt).*(x-xr) + (x-xb).*(x-xr) + (x-xb).*(x-xt))/(xl-xb)/(xl-xt)/(xl-xr);
                case 2
                    result = ((x-xt)+(x-xr) + (x-xb)+(x-xr) + (x-xb)+(x-xt))/(xl-xb)/(xl-xt)/(xl-xr);
        ...
        case 2  % for xr
            switch basis_der
                case 0
                    result = (x-xl).*(x-xb).*(x-xt).*(x-xc)/(xr-xl)/(xr-xb)/(xr-xt)/(xr-xc);
                case 1
                    result = ((x-xl).*(x-xb) + (x-xb).*(x-xt) + (x-xl).*(x-xt))/(xr-xl)/(xr-xb)/(xr-xt);
                case 2
                    result = ((x-xl)+(x-xb) + (x-xb)+(x-xt) + (x-xl)+(x-xt))/(xr-xl)/(xr-xb)/(xr-xt);
        ...
        case 3  % for xb
            switch basis_der
                case 0
                    result = (x-xl).*(x-xt).*(x-xr).*(x-xr)/(xb-xl)/(xb-xt)/(xb-xr)/(xb-xc);
                case 1
                    result = ((x-xl).*(x-xt) + (x-xt).*(x-xr) + (x-xl).*(x-xr))/(xb-xl)/(xb-xt)/(xb-xr);
                case 2
                    result = ((x-xl)+(x-xt) + (x-xt)+(x-xr) + (x-xl)+(x-xr))/(xb-xl)/(xb-xt)/(xb-xr);
        ...
        case 4  % for xc
            switch basis_der
                case 0
                    result = (x-xl).*(x-xb).*(x-xr).*(x-xt)/(xc-xl)/(xc-xb)/(xc-xr)/(xc-xt);
                case 1
                    result = ((x-xl).*(x-xb) + (x-xb).*(x-xr) + (x-xl).*(x-xr))/(xt-xl)/(xt-xb)/(xt-xr);
                case 2
                    result = ((x-xl)+(x-xb) + (x-xb)+(x-xr) + (x-xl)+(x-xr))/(xt-xl)/(xt-xb)/(xt-xr);
            ...
            switch basis_der
                case 0
                    result = (x-xl).*(x-xb).*(x-xr).*(x-xc)/(xt-xl)/(xt-xb)/(xt-xr)/(xt-xc);
                case 1
                    result = ((x-xl).*(x-xb) + (x-xb).*(x-xr) + (x-xl).*(x-xr))/(xt-xl)/(xt-xb)/(xt-xr);
                case 2
                    result = ((x-xl)+(x-xb) + (x-xb)+(x-xr) + (x-xl)+(x-xr))/(xt-xl)/(xt-xb)/(xt-xr);
